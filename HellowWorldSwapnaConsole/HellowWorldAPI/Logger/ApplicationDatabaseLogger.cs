/// <summary>
/// This file is responsible for writing the application errors to a database.  not used in this project.
/// </summary>
...
{
    public class ApplicationDatabaseLogger : ILogger
    {
        private string DatetimeFormat;
        private string Filename;
        public ApplicationDatabaseLogger()
        {
        ...
        private void WriteLineToDB(string text, bool append = true)
        {
            try
            {
               //to do -- implement log to DB method here.
            }
            catch
            {
                throw;
